...
export function registerOrderTools(server: McpServer, apiClient: ApiClient) {
  server.tool(
    ...
    'Query sandbox orders by type: trade, pay, disburse, paylink, subscription. Two modes: (1) exact query with outTradeNo or payRequestNos, (2) recent records — returns the latest 15 orders sorted by creation time descending.',
    {
