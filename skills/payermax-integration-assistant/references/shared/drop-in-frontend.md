...
1. Load PayerMax Drop-In JS SDK via CDN:
   ...
   Source: https://docs.payermax.com/en/doc-center/acquiring/start-integration/create-payment/frontend-component.md
 ...
 * https://docs.payermax.com/en/doc-center/receipt/test-cases.md (section 2.2 Card)
 *
...
const TEST_CARDS = [
  ...
  // ... include ALL cards from https://docs.payermax.com/en/doc-center/receipt/test-cases.md section 2.2
];
