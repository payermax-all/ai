...
| Topic | URL to fetch |
|---|---|
| Dispute introduction | `https://docs.payermax.com/en/doc-center/receipt/chargeback/introduction.md` |
| Backend notification | `https://docs.payermax.com/en/doc-center/receipt/chargeback/backend-notification.md` |
| Inquiry handling | `https://docs.payermax.com/en/doc-center/receipt/chargeback/inquiry.md` |
| Retrieval response | `https://docs.payermax.com/en/doc-center/receipt/chargeback/retrieval-response.md` |
| Response codes | `https://docs.payermax.com/en/doc-center/receipt/chargeback/response-code.md` |
